                ...
                <div className="max-w-7xl mx-auto px-8 py-16">
                    ...
                    <div className="grid lg:grid-cols-2 gap-14 items-center">
                        ...
                        <div className="flex justify-center">
                            ...
                            <div className="w-80 h-80 rounded-full bg-blue-500/20 backdrop-blur flex justify-center items-center shadow-[0_0_100px_rgba(59,130,246,.5)]">
                ...
                <div className="bg-white rounded-3xl shadow-2xl p-8">
                    ...
                    {result && (
                        ...
                        <><div className="mt-10 space-y-6">
                            ...
                            <div className="bg-slate-50 rounded-2xl p-6">
                            ...
                            </div><div className="bg-white border rounded-2xl p-6">
                            ...
                            </div><div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
                                ...
                                {result.level === "DANGEROUS" && (
                                    ...
                                    <p className="text-red-700 leading-8">
                                        ...
                                        Avoid visiting or interacting with this website. It
                                        exhibits multiple phishing indicators and could put
